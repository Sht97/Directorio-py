...
def validate():
    ...
    if re.match(patronName, name.get()): validateVar += 1
    else: messagebox.showinfo("Error", 'El campo "Nombre" no cumple con el formato.')
    if re.match(patronName, lastName.get()): validateVar += 1
    else: messagebox.showinfo("Error", 'El campo "Apellido" no cumple con el formato.')
    if re.match(patronTel, tel.get()): validateVar += 1
    else: messagebox.showinfo("Error", 'El campo "Teléfono" no cumple con el formato.')
    if re.match(patronTel, cel.get()): validateVar += 1
    else: messagebox.showinfo("Error", 'El campo "Celular" no cumple con el formato.')
    if re.match(patronEmail, email.get()): validateVar += 1
    else: messagebox.showinfo("Error", 'El campo "Correo" no cumple con el formato.')
